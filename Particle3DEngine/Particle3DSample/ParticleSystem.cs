...
namespace Particle3DSample
{
    ...
    public abstract class ParticleSystem
    {
        ...
        public void LoadContent()
        {
            ...
            vertexBuffer = new DynamicVertexBuffer(Particle3DSampleGame.graphics.GraphicsDevice, ParticleVertex.VertexDeclaration,
            ...
            indexBuffer = new IndexBuffer(Particle3DSampleGame.graphics.GraphicsDevice, typeof(ushort), indices.Length, BufferUsage.WriteOnly);
        ...
        {
            GraphicsDevice device = Particle3DSampleGame.graphics.GraphicsDevice;
        ...
        public int NumberOfActiveParticles()
        {
            ...
            {
                int num = (settings.MaxParticles - firstActiveParticle) + firstFreeParticle;
                // If the active particle range wraps past the end of the queue
                // back to the start, we must split them over two draw calls.
